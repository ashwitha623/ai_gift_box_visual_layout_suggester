...
export const BOX_TEMPLATES = [
  {
    ...
    occasions: ["corporate", "anniversary", "farewell"],
    cost: 500
  },
  {
    id: "premium_showcase",
    name: "Premium Showcase Box",
    style: "Ivory Embossed Showcase",
    length: 30.0,
    width: 22.0,
    height: 10.0,
    capacity: 6600.0,
    ribbonStyle: "Champagne Gold Bow",
    ribbonHex: "#d4af7a",
    packagingTheme: "Elegant Ivory",
    occasions: ["anniversary", "wedding", "graduation"],
    cost: 400
  },
  {
    id: "corporate_executive",
    name: "Corporate Executive Box",
    style: "Matte Navy Rigid",
    length: 28.0,
    width: 20.0,
    height: 10.0,
    capacity: 5600.0,
    ribbonStyle: "Silver Satin Bow",
    ribbonHex: "#9aa5b1",
    packagingTheme: "Executive Navy",
    occasions: ["corporate", "farewell"],
    cost: 350
  },
  {
    id: "wedding_hamper",
    name: "Wedding Hamper Box",
    style: "Pastel Lace Tray",
    length: 36.0,
    width: 28.0,
    height: 14.0,
    capacity: 14112.0,
    ribbonStyle: "White Organza Bow",
    ribbonHex: "#ece2d0",
    packagingTheme: "White Wedding",
  ...
  },
  {
    ...
    style: "Colorful Confetti Box",
    length: 26.0,
    width: 18.0,
    height: 12.0,
    capacity: 5616.0,
    ribbonStyle: "Blush Pink Ribbon",
    ribbonHex: "#f4a7b9",
    packagingTheme: "Confetti Party",
    occasions: ["birthday", "just_because", "friendship", "baby_shower"],
    cost: 300
  },
  {
    id: "romantic_elegance",
    name: "Romantic Elegance Box",
    style: "Deep Rose Velvet Box",
    length: 28.0,
    width: 22.0,
    height: 11.0,
    capacity: 6776.0,
    ribbonStyle: "Deep Rose Velvet Bow",
    ribbonHex: "#c94f6d",
    packagingTheme: "Velvet Love",
    occasions: ["anniversary", "wedding", "baby_shower", "friendship"],
    cost: 450
  }
];
